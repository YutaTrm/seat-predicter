          ...
          <>
            ...
            >
              <div className="space-y-4">
                <p className=''>
                  これは登録済みチケットから算出した分布あり、構成予想ではありませんのでご注意ください。
                </p>
                <p className=''>
                  画像はタップで別画面で開けて、長押しで保存できます。画像は転載OKです。
                </p>
                <p>
                  ブロックは同じアルファベットを横一列に並べて、各ブロックの大きさは登録されたチケットの最大値に合わせて自動調整しています。
                </p>
                <p>
                  ブロック全体は横方向中央に寄せて表示し、チケットが無いブロックは5x5で配置しています。
                </p>
              </div>
            </Modal>
          </>
