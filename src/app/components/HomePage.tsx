    ...
    <main className="container mx-auto px-4 py-6 md:grid md:grid-cols-3 md:auto-rows-max md:gap-4">
      ...
      <section className="md:col-span-3 md:mb-8">
        <div className="flex justify-between">
          <div className="flex-1">
            <h1 className="text-2xl text-rose-500 font-bold">{t('home.title')}</h1>
            <p className="text-xs text-rose-300" style={{ whiteSpace: 'pre-line' }}>{t('home.subtitle')}</p>
          </div>
      ...
      <section className="mt-8 md:col-span-1 md:mt-0">
        <div className="flex items-center gap-2">
          <h2 className="text-lg text-gray-600 font-bold mb-1">{t('home.ticketInput')}</h2>
          {/* ローディング状態の表示 */}
      ...
      <section className="mt-8 md:col-span-2 md:mt-0">
        <div className="flex justify-between items-center mb-1">
          <h2 className="text-lg text-gray-600 font-bold">
            ...
            <span className='text-sm text-gray-500 ml-1'>{t('home.tickets')}<span className='text-rose-500'>{totalTicketCount}</span>{t('home.count')}</span>
          </h2>
          {selectedArtist && selectedTour && (
            <button
              onClick={postToX}
          ...
          <>
            <div className="mt-8">
              <div className="flex justify-between items-center mb-2">
                <h2 className="text-lg text-gray-600 font-bold">{t('home.seatDistribution')}</h2>
                <button
                  onClick={() => setShowGridHelp(true)}
                  className="text-sm text-rose-500 hover:text-rose-700"
                >
                  {t('home.distributionAbout')}
                </button>
              </div>
              {tickets.length >= 15 ? (
                <TicketGrid
            ...
            {selectedTourResultPostUrl && (
              <div className="mt-8 mb-2">
                <div className="flex justify-between items-center">
                  <h2 className="text-lg text-gray-600 font-bold">{t('home.actualConfiguration')}</h2>
                  <button
            ...
            <Modal
              ...
              title={t('home.distributionModal.title')}
            >
              <div className="space-y-4">
                <p className=''>
                  {t('home.distributionModal.note1')}
                </p>
                <p className=''>
                  {t('home.distributionModal.note2')}
                </p>
                <p>
                  {t('home.distributionModal.note3')}
                </p>
                <p>
                  {t('home.distributionModal.note4')}
                </p>
              </div>
            </Modal>
          </>
